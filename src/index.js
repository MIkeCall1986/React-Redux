...
class App extends Component {
  ...
  searchName = (e) => {
    ...
    this.setState({
      findContact: this.searchName,
    });
  };
  onShowContact = (items, searchValue) => {
    if (this.searchName === 0) {
      return items;
    }
      ...
      <Provider store={store}>
        <Router>
          ...
          <Switch>
            ...
            <Route
              path='/edit-contact'
              render={() => <EditContact onEditCurrentContact={this.onEditCurrentContact} Contact={CurrentContact} />}
            />
